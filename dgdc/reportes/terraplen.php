...
//valores de pertenencia
	...
	$pdf->Cell(45,5,'Cadenamiento inicial',1,0,'C',true);
	...
	$pdf->Cell(45,5,$consulta['cadCarretera']['inicial'],1,0,'C',true);
	$pdf->Cell(45,5,$consulta['coordenadas']['inicial'][1],1,0,'C',true);
	$pdf->Cell(45,5,$consulta['coordenadas']['inicial'][0],1,0,'C',true);	
	$pdf->Ln(10);

	$pdf->SetFillColor(230,230,230);
	$pdf->Cell(45,5,'Cadenamieto final',1,0,'C',true);
	$pdf->Cell(45,5,'Latitud',1,0,'C',true);
	$pdf->Cell(45,5,'Longitud',1,0,'C',true);
	$pdf->Ln();
	...
	$pdf-> AddFont('gothic_0');//MYRIADPROREGULAR
	$pdf->SetFont('gothic_0','',9);//MYRIADPROREGULAR
	$pdf->Cell(45,5,$consulta['cadCarretera']['final'],1,0,'C',true);
	$pdf->Cell(45,5,$consulta['coordenadas']['final'][1],1,0,'C',true);
	$pdf->Cell(45,5,$consulta['coordenadas']['final'][0],1,0,'C',true);
	$pdf->Ln(10);

	$pdf->Cell(45,5,'Medida',1,0,'C',true);	
	$pdf->SetDrawColor(111,114,115);
	$pdf->Cell(45,5,'Posicion',1,0,'C',true);
	$pdf->Cell(45,5,'Tipo',1,0,'C',true);
	$pdf->Ln();

	$pdf->SetFillColor(255,255,255);
	$pdf-> AddFont('gothic_0');//MYRIADPROREGULAR
	$pdf->SetFont('gothic_0','',9);//MYRIADPROREGULAR
	$pdf->Cell(45,5,$consulta['medida'],1,0,'C',true);
	$pdf->Cell(45,5,$consulta['ubicacionLado'],1,0,'C',true);
	$pdf->Cell(45,5,$consulta['rubro'],1,0,'C',true);
	$pdf->Ln(10);
